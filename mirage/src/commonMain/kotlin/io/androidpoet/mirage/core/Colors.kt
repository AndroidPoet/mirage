 ...
 */
public fun MirageUniforms.setColorsUniform(name: String, countName: String, colors: List<Color>, maxCount: Int) {
...
public fun MirageUniforms.setColorUniform4f(name: String, color: Color) {
